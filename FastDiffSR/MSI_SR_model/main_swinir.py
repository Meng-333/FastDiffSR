...
def main():
    ...
    # test
    #net.mfeNew_validate(epoch=100, modelpath='./Result/SwinIR/model/generator_param.pkl')
    net.mfeNew_validateByClass(100, save_img=True, modelpath="./Result/SwinIR/model/generator_param.pkl")

    # # 单张图片推理
    # #UCM_input_img scale_factor=4 crop_size=test_crop_size=hr_height=hr_width=128
    #net.dm_test_single(img_fn="../dataset/UCM_128_512/lr_128/", modelpath="../checkpoint/swinir_x4_generator_param.pkl")
