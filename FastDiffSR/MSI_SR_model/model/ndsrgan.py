...
class NDSRGAN(object):
    ...
    def dm_test_single(self, img_fn, modelpath=None):
        # networks
        cuda = True if torch.cuda.is_available() else False
        self.generator = GeneratorResNet(in_channels=3, out_channels=3, nf=64, nc=32, upscale_factor=4)
        ...
        for img_ in imgs:
            ...
            srutils.save_img1(recon_imgs[0].cpu().data, self.save_dir, self.save_dir + '/SR_ndsrgan_x4_%s' % img_)
