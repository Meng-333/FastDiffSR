...
class SinusoidalPosEmb(nn.Module):
    ...
    def forward(self, x):
        ...
        #print('x:', type(x), x.size(), x.shape, x)
        #print('emb:', type(emb), emb.size(), emb.shape, emb)
        emb = x[:, None] * emb[None, :]
        #print('emb___after:', type(x[:, None]), x[:, None].size(), emb[None, :].shape, emb[None, :])
        #print('emb_____:', type(emb), emb.size(), emb.shape, emb)
